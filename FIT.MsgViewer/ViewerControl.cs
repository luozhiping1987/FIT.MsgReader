...
using FIT.MsgReader;
using FIT.MsgViewer.Helpers;
using FIT.MsgViewer.Properties;
    ...
    public partial class ViewerControl : UserControl
    {
        ...
        private void ApplyToParentForm()
        {
            ...
            {                
                ...
                this.ParentForm.MainMenuStrip = this.menuStrip1;
                this.ParentForm.WindowState = global::FIT.MsgViewer.Properties.Settings.Default.WindowState;
                this.ParentForm.Closing += ViewerForm_Closing;
            }
        }
