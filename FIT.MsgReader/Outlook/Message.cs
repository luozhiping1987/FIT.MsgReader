...
using System.Text;
using FIT.MsgReader.Exceptions;
using FIT.MsgReader.Helpers;
using FIT.MsgReader.Localization;
using FIT.MsgReader.Mime.Header;
...
namespace FIT.MsgReader.Outlook
{
