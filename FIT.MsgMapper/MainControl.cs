...
using FIT.MsgMapper.Properties;
...
namespace FIT.MsgMapper
{
    public partial class MainControl : UserControl
    {
        ...
        #region ParentForm
        private bool _applyFormEvents = false;
        /// <summary>
        /// Property will instruct control to aplly certain events and attributes to the parent control as if the usercontrol
        /// itself was a form.
        /// </summary>
        public bool ApplyFormEvents { get => _applyFormEvents; set => _applyFormEvents = value; }

        private void ApplyToParentForm()
        {
            if (_applyFormEvents == true && this.ParentForm != null)
            {
                this.ParentForm.Visible = false; // Hide form window.
                this.ParentForm.ShowInTaskbar = false; // Remove from taskbar.

                this.ParentForm.FormBorderStyle = System.Windows.Forms.FormBorderStyle.FixedSingle;
                //this.ParentForm.Icon = new Icon(Icon, 40, 40);
                this.ParentForm.Icon = ((System.Drawing.Icon)(Properties.Resources.ResourceManager.GetObject("$this.Icon")));
                this.ParentForm.MaximizeBox = false;
                this.ParentForm.MinimizeBox = false;
                this.ParentForm.SizeGripStyle = System.Windows.Forms.SizeGripStyle.Hide;
                this.ParentForm.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
                this.ParentForm.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.MainForm_FormClosing);
            }
        }
